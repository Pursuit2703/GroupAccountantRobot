...
DRAFT_TTL_SECONDS = int(os.environ.get("DRAFT_TTL_SECONDS", 20))
REJECTED_TTL_SECONDS = int(os.environ.get('REJECTED_TTL_SECONDS', 30))
PENDING_TTL_SECONDS = int(os.environ.get('PENDING_TTL_SECONDS', 30))
