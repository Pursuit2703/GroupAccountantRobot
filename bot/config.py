...
DRAFT_TTL_SECONDS = int(os.environ.get("DRAFT_TTL_SECONDS", 900))
REJECTED_TTL_SECONDS = int(os.environ.get('REJECTED_TTL_SECONDS', 3600))
PENDING_TTL_SECONDS = int(os.environ.get('PENDING_TTL_SECONDS', 86400))
